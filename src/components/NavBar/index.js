...
const NavBar = React.memo(
    ({
        ...
        return (
            ...
            >
                <Box
                    style={!title && label ? styles.widthHorizontalFull : styles.widthHorizontal}
                    padding={[0, 15, 0, 0]}
                    justify="flex-start"
                    flexDirection="row"
                    align="center"
                            ...
                            {leftIcon && (
                                <>
                                    <ImageIcon
                                        ...
                                        margin={[0, 0, 0, 5]}
                                    />
                                    <Text color={COLOR} style={styles.sizeTitle} textAlign="center">
                                        {label}
                                    </Text>
                                </>
                            )}
                ...
                {title ? (
                    <Box style={styles.widthCenter} justify="center" align="center" height={'100%'}>
                        {componentCenter ? (
                            componentLeft()
                        ) : (
                            <Text color={COLOR_TITLE} style={styles.sizeTitle} textAlign="center">
                                {title}
                            </Text>
                        )}
                    </Box>
